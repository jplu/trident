...
func TestApplyDotSegmentRules(t *testing.T) {
	testCases := []struct {
		...
		{
			name: "Rule 2A: ../ prefix", in: "../a/b", output: []string{},
			expectedIn: "a/b", expectedOut: []string{}, expectedOk: true,
		},
		{
			name: "Rule 2A: ./ prefix", in: "./a/b", output: []string{},
			expectedIn: "a/b", expectedOut: []string{}, expectedOk: true,
		...
		{
			name: "Rule 2B: /./ prefix", in: "/./a/b", output: []string{},
			expectedIn: "/a/b", expectedOut: []string{}, expectedOk: true,
		},
		{
			name: "Rule 2B: /. exact", in: "/.", output: []string{},
			expectedIn: "/", expectedOut: []string{}, expectedOk: true,
		},
		{
			name: "Rule 2C: /../ prefix with non-empty output", in: "/../a/b", output: []string{"/parent"},
			expectedIn: "/a/b", expectedOut: []string{}, expectedOk: true,
		},
		{
			name: "Rule 2C: /.. exact with non-empty output", in: "/..", output: []string{"/parent"},
			expectedIn: "/", expectedOut: []string{}, expectedOk: true,
		},
		{
			name: "Rule 2C: /../ with empty output", in: "/../a", output: []string{},
			expectedIn: "/a", expectedOut: []string{}, expectedOk: true,
		},
		{
			name: "Rule 2C: /../ with relative last segment in output", in: "/../c", output: []string{"a", "b"},
			expectedIn: "/c", expectedOut: []string{"a"}, expectedOk: true,
		},
		{
		...
		{
			name: "No rule applies", in: "/a/b/c", output: []string{},
			expectedIn: "/a/b/c", expectedOut: []string{}, expectedOk: false,
		},
		{
			name: "No rule applies, empty in", in: "", output: []string{},
			expectedIn: "", expectedOut: []string{}, expectedOk: false,
		},
	}
...
func TestResolvePath(t *testing.T) {
	testCases := []struct {
		...
		{name: "Both paths are empty", basePath: "", relPath: "", expected: ""},
	}
